...
export default function PricingPage() {
  const [billingCycleByPlan, setBillingCycleByPlan] = useState<
  ...
  const getCycle = (key: string) =>
    billingCycleByPlan[key] ?? "yearly";
