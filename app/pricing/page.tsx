      ...
      <div className="pricing__content__K9j6q">
        <header className="pricing__header__P8k4q">
          ...
          <p className="typography__subtitle__R6m2x pricing__subtitle__B3n7p" style={{ margin: 0 }}>
            Four yearly plans built on Next.js + Vercel, with Shopify-ready options for commerce.
          </p>
        </header>
          ...
          {plans.map((plan) => (
            ...
            >
              <div className="pricing__card-top__A1b2c">
                ...
                <p className="typography__small__Q9j2p pricing__billing__C2d3e" style={{ margin: 0 }}>
