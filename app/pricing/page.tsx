...
const faIcons: Record<string, IconDef> = {
  ...
  "Next.js + Vercel deployment": {
    ...
    path: "M537.6 226.6C521.6 135.3 443.6 64 352 64c-70.7 0-132.1 43.1-156.9 105.2C108.1 179.6 48 246.6 48 328c0 88.4 71.6 160 160 160h112V320h-64l96-96 96 96h-64v168h96c79.5 0 144-64.5 144-144 0-70.6-50.9-129.3-118.4-137.4z",
  },
  "Automatic CI/CD": {
    viewBox: "0 0 512 512",
    // rotate / sync
