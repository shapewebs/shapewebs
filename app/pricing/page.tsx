...
const faIcons: Record<string, IconDef> = {
  ...
  "Next.js + Vercel deployment": {
    ...
    path:"M 4.8 9.6 L 2.213 9.6 C 1.59 9.6 1.208 8.923 1.528 8.388 L 2.85 6.183 C 3.068 5.82 3.458 5.6 3.88 5.6 L 6.255 5.6 C 8.158 2.378 10.995 2.215 12.893 2.493 C 13.213 2.54 13.463 2.79 13.508 3.108 C 13.785 5.005 13.623 7.843 10.4 9.745 L 10.4 12.12 C 10.4 12.543 10.18 12.933 9.818 13.15 L 7.613 14.473 C 7.08 14.793 6.4 14.408 6.4 13.788 L 6.4 11.2 C 6.4 10.318 5.683 9.6 4.8 9.6 L 4.798 9.6 L 4.8 9.6 Z M 11.6 5.6 C 11.6 4.938 11.063 4.4 10.4 4.4 C 9.738 4.4 9.2 4.938 9.2 5.6 C 9.2 6.263 9.738 6.8 10.4 6.8 C 11.063 6.8 11.6 6.263 11.6 5.6 Z",
  },
  "Automatic CI/CD": {
    viewBox: "0 0 512 512",
    // rotate / sync
