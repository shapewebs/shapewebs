  ...
  return (
    <div className="contact__container__Q7j3s">
      <section className="contact__content__K9j6q">
        ...
        <p className="contact__reason-title__C7p2m"><span>Start with a custom demo</span><span>Discover the value of a carefully crafted web presence by Shapewebs.</span></p>
        <p className="contact__reason-title__C7p2m"><span>See the process in action</span><span>From idea to launch, you can learn about our <a href="/method" className="typography__link__B7s3m">method</a> or talk to sales.</span></p>
              ...
              <div className="contact__form-consent__R5j2s"> 
                <div className="contact__consent-content__P5k8p"> 
                  <label htmlFor="consentMarketing" className="contact__consent-label__B9k6p"> Yes, I agree to receive marketing communications from Shapewebs as described in your{" "} 
                    <a href="/privacy-policy" className="typography__link__B7s3m"> Privacy Policy </a> . I can withdraw my consent at any time by clicking the unsubscribe link in the emails. 
                  </label> 
