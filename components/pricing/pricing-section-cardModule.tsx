  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M16 8C16 12.4183 12.4183 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 8ZM11.5303 6.53033L12.0607 6L11 4.93934L10.4697 5.46967L6.5 9.43934L5.53033 8.46967L5 7.93934L3.93934 9L4.46967 9.53033L5.96967 11.0303C6.26256 11.3232 6.73744 11.3232 7.03033 11.0303L11.5303 6.53033Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M16 8C16 12.4183 12.4183 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 8ZM10.5 11.5607L9.96967 11.0303L8 9.06066L6.03033 11.0303L5.5 11.5607L4.43934 10.5L4.96967 9.96967L6.93934 8L4.96967 6.03033L4.43934 5.5L5.5 4.43934L6.03033 4.96967L8 6.93934L9.96967 4.96967L10.5 4.43934L11.5607 5.5L11.0303 6.03033L9.06066 8L11.0303 9.96967L11.5607 10.5L10.5 11.5607Z"
        fill="currentColor"
      />
    </svg>
  );
        ...
        <div className="performance__content__K9j6q">
          ...
          >
            ...
            >
              ...
              >
                {planOrder.map((p) => {
                  const isHighlighted = p.key === "plus";
                  return (
                    <div
                      key={p.key}
                    ...
                    >
                      ...
                      {/* Button kind is controlled ONLY by data-highlighted */}
                      <button
                        type="button"
                        className={[
                          "button__root__R5j2s",
                ...
                return (
                  <div key={`feat-${idx}-${r.label}`} className="performance__row__P5k8p" role="row">
                    {planOrder.map((p) => (
                      ...
                      >
                        <FeatureCell enabled={r.availability[p.key]} label={r.label} tooltip={r.tooltip} />
                      </div>
                    ))}
                  </div>
                );
