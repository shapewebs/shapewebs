...
const feat = (iconIndex: number, text: string, tooltip?: string) => ({
  iconIndex,
  text,
...
const plans: Plan[] = [
  {
    ...
    features: [
      feat(0, "Next.js + Vercel deployment"),
      feat(
        1,
        "Web Application Firewall",
        "Security layer that protects your website from common web attacks and threats"
      ),
      feat(
        2,
        "DDoS Mitigation",
        "Protection against Distributed Denial of Service attacks that could overwhelm your site"
      ),
      feat(3, "Basic SEO"),
      feat(4, "Email support"),
    ],
...

  {
    ...
    // NOTE: Cold start prevention + Priority support moved to Business (with their original icons)
    features: [
      feat(6, "Traffic & performance insights"),
      feat(7, "Content structure + conversion guidance"),
      feat(
        8,
        "Enhanced SEO + analytics",
        "Advanced tools to track rankings, optimize for search engines, and understand visitor behavior"
      ),
...

  {
    ...
    features: [
      feat(
        ...
        "Keeps your site running fast by avoiding delays when a function hasn't been used recently"
      ),
      feat(
        11,
        "Faster builds with prioritized CI",
        "Your code deploys faster by getting priority in the build queue"
      ),
      feat(
        12,
        "Advanced caching & ISR configuration",
        "Incremental Static Regeneration allows pages to update without rebuilding your entire site"
      ),
      feat(13, "Technical SEO improvements"),
      feat(
        14,
        "Performance budgets (Core Web Vitals)",
        "Set limits on page performance metrics to ensure users have a fast experience"
      ),
...

  {
    ...
    features: [
      feat(15, "Unlimited pages & components"),
      feat(
        16,
        "Advanced security (SSO, RBAC)",
        "Single Sign-On for easy user management + Role-Based Access Control for fine-grained permissions"
      ),
      feat(
        17,
        "Compliance support (SOC 2, GDPR)",
        "Help meeting security standards (SOC 2) and data privacy regulations (GDPR)"
      ),
      feat(
        18,
        "Custom SLAs & uptime guarantees",
        "Service Level Agreements - guaranteed minimum uptime and performance commitments"
      ),
      feat(19, "Dedicated support & onboarding"),
    ],
      ...
      <section className="pricing__container__Q7j3s">
        <div className="pricing__content__K9j6q">
          ...
          <p
            ...
            style={{ margin: 0, textAlign: "center", maxWidth: "75%" }}
          >
          ...
          <div className="pricing__grid__L7p3s">
            {plans.map((plan) => {
              ...
              const ctaKindClass = plan.highlighted
                ...
                >
                  <div className="pricing__card-top__A1b2c">
                    ...
                    <div className="pricing__price__T7g2m">
                      <span className="typography__body__K4n7p">{plan.description}</span>

                      <span className="typography__body__K4n7p bitC1">
                        {amount != null ? (
                          <>
                            $<RollingNumber value={amount} /> {plan.priceSuffix}
                          </>
                        ) : plan.priceHref ? (
                    ...
                    <div className="pricing__billing__C2d3e">
                      ...
                      <span className="typography__small__Q9j2p">{plan.billingLabelYearly}</span>
                    </div>
                  </div>
                  ...
                  <ul className="pricing__features__M93j8">
                    {plan.features.map((f, i) => {
                      const Icon = FeatureIcons[f.iconIndex];
                      return (
                        <li
                          key={`${plan.key}-${i}-${f.text}`}
                          className="pricing__feature__P5k8p"
                        >
                          ...
                          {f.tooltip ? (
                            <Tooltip content={f.tooltip} position="right">
                  ...
                  <div className="pricing__actions__Q6z2k">
                    <a
                      href={plan.cta.href}
                      className={`button__root__ZxcvB ${ctaKindClass} button__size-medium__L9d7h pricing__cta__X1y2z`}
