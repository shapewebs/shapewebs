    ...
    <section className="section__8NC91">
      <div className="section__content__0KLF3">
        <span className="hide-tablet">
          <p className="typography__body__K4n7p" style={{margin: "0"; text-align: center;}}>Tools at the leading edge of web development. Trusted by leading companies including OpenAI, Netflix, and Nike.</p>
        </span>
